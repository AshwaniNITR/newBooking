...
const Page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const apiResponse = await fetch("https://8103-34-73-28-213.ngrok-free.app/generate", {
        method: "POST",
        headers: {
  ...
  const handleTranslate = async (langPair) => {
    ...
    try {
      ...
      const apiResponse = await fetch("https://7e4a-34-45-84-7.ngrok-free.app/translate", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
