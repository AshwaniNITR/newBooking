  ...
  return (
    ...
    >
      <motion.div 
        ...
        >
      <Image width={100} height={50} src="/favicon.png" className=" h-44 rounded-2xl" alt="Logo"></Image>
      </motion.div>
      <div className="relative z-10 flex flex-col items-center mb-32">
        ...
        ><div className="flex flex-col"><Image src="https://res.cloudinary.com/duwddcqzi/image/upload/v1742665807/business_13800592_angzvc.png" alt="" className="h-40 transition-transform group-hover:-rotate-3 group-active:-rotate-12" />
          Generate Caption
            </div>
        </motion.button>
        ...
        ><div className="flex flex-col"><Image src="https://res.cloudinary.com/duwddcqzi/image/upload/v1742666359/image_419252_xe3gf8.png" alt="" className="h-40 transition-transform group-hover:-rotate-3 group-active:-rotate-12" />
          Generate Image
            </div>
        </motion.button>
        <motion.button
